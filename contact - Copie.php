...
<body>
    ...
    $menu1C=new menuC();
    $listemenu=$menu1C->affichermenu($menu1C);

    //var_dump($listemenu->fetchAll());
    ?>
    <div class="col-md-6">
    ...
    <tbody>
       ...
       <tr>
		   ...
		   <td><?PHP echo $row['description_plat']; ?></td>
    ...
    <?php
     ...
     <html>
          <head>
               <meta charset="utf-8">
               <title> Statistiques des prix </title>
          ...
          <body>
               ...
               <div style="width:900px;">
                    <h3 align="center"> LES STATISTIQUES DES prix </h3>
                    <br />
