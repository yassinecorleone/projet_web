                                            ...
                                            <div class="info clearfix">
                                                <div class="image">
                                                 ...
                                                 <div class="content">
                                                    ...
                                                    <span class="email">yassine.brirmi@esprit.tn</span>
                                                </div>
                                            </div>
...
if (isset($_GET['prix_plat'])){
	$menuC=new menuC();
    $result=$menuC->recuperermenu($_GET['prix_plat']);
    ...
    <div class="panel-body">
        <form role="form">
                    <div class="form-group has-success">
                        <label class="control-label" for="success">Saisir le prix_plat</label>
                        <input type="number" class="form-control" id="success" name="prix_plat" value="<?PHP echo $prix_plat?>"/>
                    </div>
                    <div class="form-group has-warning">
                        <label class="control-label" for="warning">saisir le nom_plat</label>
                        <input type="text" class="form-control" id="warning" name="nom_plat" value="<?PHP echo $nom_plat ?>"/>
                    </div>
                    <div class="form-group has-error">
                        <label class="control-label" for="error">saisir le num_plat</label>
                        <input type="text" class="form-control" id="error" name="num_plat" value="<?PHP echo $num_plat ?>"/>
					</div>

                    <div class="form-group has-success">
                        <label class="control-label" for="success">Saisir la description_plat</label>
                        <select class="form-control" name="description_plat" type="text" >
                        <option><?PHP echo $description_plat ?></option>
                        <option>piquant(e)</option>
                        <option>sauce blache </option>
                        <option>fruit de mer</option>
                        <option>thon fromage</option>
                        <option>sauce champignon</option>
                        <option>seignant</option>
                        <option>à point</option>
                        <option>bien cuit</option>
                         <option>4 saison</option>
                         <option>margerita</option>
                            <option>à la tunisienne </option>
...
<input type="hidden" name="prix_plat_ini" value="<?PHP echo $_GET['prix_plat'];?>">
...
if (isset($_POST['modifier'])){
	$menu=new menu($_POST['prix_plat'],$_POST['nom_plat'],$_POST['num_plat'],$_POST['description_plat']);
	$menuC->modifiermenu($menu,$_POST['prix_plat_ini']);
	echo $_POST['prix_plat_ini'];
